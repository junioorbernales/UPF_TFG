"""
Long Short-Term Memory (LSTM) network for neural modeling of spring reverb.

https://github.com/francescopapaleo/neural-audio-spring-reverb/blob/main/src/neural_audio_spring_reverb/networks/lstm.py
...
sys.path.append(str(ROOT / "deps" / "neural_audio_spring_reverb"))
